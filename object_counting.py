...
def get_masked_fixed_color(image, boxes, masks, class_ids, class_names,
    ...
    for key,value in objects.items():
      if key!='backpack' and key!='handbag' and key!='traffic light' and key!='parking meter' and key!='stop sign':
        total=total+value
    print("Total Number of objects: ",total)
    if total > 10:
      print("Traffic Density is High\n")
    else:
      print("Traffic Density is Low\n")
    return masked_image
...
#image1 = cv2.imread('Datasets/vehicle.png')
...
for image1 in images: 
  ...
  #print (t)
  j=0
  cv2.imwrite("outputs/result%04i.png" %j, masked_image_batch[0])
  j+=1